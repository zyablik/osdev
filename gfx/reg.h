...
#define HSW_SURFACE_SHADER_CHANNEL_SELECT_A_SHIFT 16
#define HSW_SURFACE_SHADER_CHANNEL_SELECT_B_SHIFT 19
#define HSW_SURFACE_SHADER_CHANNEL_SELECT_G_SHIFT 22
#define HSW_SURFACE_SHADER_CHANNEL_SELECT_R_SHIFT 25
#define HSW_SURFACE_SHADER_CHANNEL_SELECT_MASK 0x7

#define HSW_SURFACE_SWIZZLE_RED   4
#define HSW_SURFACE_SWIZZLE_GREEN 5
#define HSW_SURFACE_SWIZZLE_BLUE  6
#define HSW_SURFACE_SWIZZLE_ALPHA 7
